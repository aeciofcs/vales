...
<head>
  ...
  <title>JSL Distribuidora | Inicio</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>JSL</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <!-- Imagem -->
              <img src="/res/admin/dist/img/LOGO-JSL.jpg" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs"><?php echo getLogin('login'); ?></span>
            </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="/vouchers/user"><i class="fa fa-money"></i> <span>Vales Lançados</span></a></li>        
        <!-- <li class="treeview">
